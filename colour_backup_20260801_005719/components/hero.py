...
def show_hero(title: str, subtitle: str, badge: str = ""):
    ...
    badge_html = f'<span style="background:#4CA9EE;color:#3E2D27;padding:4px 12px;border-radius:20px;font-size:0.8rem;font-weight:600;">{badge}</span>' if badge else ""
    ...
    ">
        {badge_html}
        <h1 style="color:#3E2D27;margin:16px 0 8px 0;font-size:2.4rem;">{title}</h1>
...
def show_page_header(icon: str, title: str, subtitle: str = ""):
    ...
    <div style="margin-bottom:16px;">
        <h1 style="color:#3E2D27;margin-bottom:4px;">{icon} {title}</h1>
